  ...
  <div class="navbar-start">
    <div class="dropdown">
      ...
      <ul tabindex="0" class="menu menu-sm dropdown-content bg-base-200 rounded-box z-[1] mt-5 w-52 p-2 shadow">
        <li><x-nav-link :active="request()->is('/')" href="{{ route('home') }}">Home</x-nav-link></li>
        <li><x-nav-link :active="request()->is('about')" href="{{ route('about') }}">About</x-nav-link></li>
        <li><x-nav-link :active="request()->is('blog')" href="{{ route('blog') }}">Blog</x-nav-link></li>
        <li><x-nav-link :active="request()->is('contact')" href="{{ route('contact') }}">Contact</x-nav-link></li>
      </ul>
    </div>
